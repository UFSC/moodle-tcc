class HubDefinition < ActiveRecord::Base
  ...
  attr_accessible :order, :position, :title, :tcc_definition, :moodle_shortname # shortname relacionado ao curso ao qual o usuário deve ser membro para ter o HubDefinition associado
