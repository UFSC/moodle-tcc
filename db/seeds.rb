...
def create_or_update_tcc_definitions(title, course_id, hub_diaries)
...
# Curso Moodle - TCC (A): 101
create_or_update_tcc_definitions('Turma A', 101, definition)
...
# Curso Moodle - TCC (B): 102
create_or_update_tcc_definitions('Turma B', 102, definition)
