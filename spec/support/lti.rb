...
def moodle_lti_params_by_person(roles = 'student', person)
...
def fake_lti_session_by_person(roles = 'student', person)
  lti_params = moodle_lti_params_by_person(roles, person)
  @tp = IMS::LTI::ToolProvider.new(Settings.consumer_key, Settings.consumer_secret, lti_params)
