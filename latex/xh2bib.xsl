<xsl:transform
  ...
  <xsl:template name="bibfields">
    ...
    <xsl:call-template name="cfield">
      <xsl:with-param name="n" select='"url"'/>
    </xsl:call-template>

    <xsl:call-template name="cfield">
      <xsl:with-param name="n" select='"urlaccessdate"'/>
    </xsl:call-template>

    <xsl:call-template name="cfield">
      <xsl:with-param name="n" select='"shorthand"'/>
    </xsl:call-template>
    ...
    <xsl:call-template name="cfield">
      <xsl:with-param name="n" select='"subtitle"'/>
    </xsl:call-template>

    <xsl:call-template name="cfield">
      <xsl:with-param name="n" select='"school"'/>
    </xsl:call-template>

    <xsl:call-template name="cfield">
      <xsl:with-param name="n" select='"note"'/>
    </xsl:call-template>
